...
> 状态：历史快照，已解冻，不得作为当前正式实现依据。
> 本文全部规范性措辞仅记录 2026-07-30 旧方案当时状态；当前停在 Gate B，
> Stage 4 未开始，尚无有效模型契约。
>
> 旧方案当时状态：惯性纯追踪与舰载起飞修订后曾冻结，现已解除
...
> 旧方案当时目的：固定四问共享的数学对象、时间语义、输入输出和成功判据。
